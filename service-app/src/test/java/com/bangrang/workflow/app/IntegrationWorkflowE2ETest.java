...
import com.bangrang.workflow.app.migration.DataMigrationWorkflow;
import com.bangrang.workflow.engine.core.DefaultWorkflowContext;
import com.bangrang.workflow.engine.core.ExponentialBackoffRetryPolicy;
import com.bangrang.workflow.engine.core.TaskExecutor;
...
public class IntegrationWorkflowE2ETest {
    ...
    void setupSchemaAndSeed() {
        // Clean and load H2 schema + sample data (engine-core provides schema-h2.sql)
