 ...
 * 모든 e2e 테스트의 기반.
 *
 * <p>실행 전제: docker compose로 service-app이 떠 있고 시스템 프로퍼티 ``swe.e2e.host``로 호스트:포트 주입.
...
public abstract class E2EBaseTest {
    ...
    static void healthCheck() {
        ...
        // service-app은 actuator 미장착 — 랜딩 페이지 ``/``로 readiness 확인
        Awaitility.await("service-app readiness")
